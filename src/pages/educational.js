...
const Educational = () => {
  ...
  const handleAddField = () => {
    setEducationFields([...educationFields, { name: '', degree: '', percentage: '', passingYear: '' }])
  }
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('/api/form-data/educational', educationFields)
      .then(response => {
  ...
  return (
    <div className="App">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {educationFields.length > 1 && <button type="button" onClick={handleRemoveField}>Remove Field</button>}
